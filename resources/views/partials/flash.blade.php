...
@if ($status = session('notify'))
    <div role="alert" class="p-4 mb-8 bg-yellow-100 text-yellow-800 rounded border border-yellow-600 flex items-center justify-between">
        {{ $status }}
    </div>
@endif
